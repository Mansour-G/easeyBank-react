  ...
  return (
    <div className='features'>
      ...
      <div className="featuresItems">
        ...
        <div className="items">
          <img src={Bank} alt="Bank" className='icons' />
        ...
        <div className="items">
          <img src={Budget} alt="Budget" className='icons' />
        ...
        <div className="items">
          <img src={Onboard} alt="Onboard" className='icons' />
        ...
        <div className="items">
          <img src={Api} alt="Api" className='icons' />
          <h3>Open API</h3>
